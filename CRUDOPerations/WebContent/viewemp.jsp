		...
		<%
			for (Employee e : employeesList) {
					 ...
					 out.print("<tr><td>"+e.getId()+"</td><td>"+e.getName()+"</td><td>"+e.getQualification()+"</td> " +
				 		"<td>"+e.getGender()+"</td><td>"+e.getDoj()+"</td><td>"+e.getPancard()+"</td><td>"+e.getDob()+"</td><td>"+e.getSalary()+"</td><td><a href='addattendenceemp?id="+e.getId()+"'>attendenceform</a></td><td><a href='updateemp?id="+e.getId()+"'>edit</a></td>" +
